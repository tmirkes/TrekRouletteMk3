    ...
    <div class="right-frame-top">
        ...
        <div class="data-cascade-button-group">
            ...
            <div class="button-col">
                <div class="button" id="top-left"><a href=""></a></div>
                <div class="button" id="bottom-left"><a href=""></a></div>
            </div>
            <div class="button-col">
                <div class="button" id="top-right"><a href=""></a></div>
                <div class="button" id="bottom-right"><a href=""></a></div>
            </div>
        ...
        <div class="content">
            ...
            <div>
                <div style="float: left; width: 50%;">
                    ...
                    <p>If you want a little more tailored experience, click on <em>Log In</em> to sign into your existing account (or sign up for a new one).  With an account, you can tell Trek Roulette what series you have available to you, making sure that you only get recommendations you can actually watch.</p>
