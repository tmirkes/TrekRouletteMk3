...
<div class="wrap" id="gap">
    ...
    <div class="right-frame">
        ...
        <div class="content">
            ...
            <p>Click the button to begin checking the remote database for new seasons and episodes.</p>

            <p><em>Note that this process is time-intensive, and may take several minutes to complete.</em></p>

            <c:choose>
                <c:when test="${updateStatus == null}">
                    <div class="button content-action" style="margin: auto;"><a href="/dbUpdate">Proceed</a></div>
                </c:when>
                <c:otherwise>
                    <p>Update check complete.</p>
