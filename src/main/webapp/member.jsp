...
<div class="wrap">
    ...
    <div class="right-frame-top">
        <div class="banner">
            TrekRoulette &#149; ${currentUser.userName}
        </div>
...
<div class="wrap" id="gap">
    ...
    <div class="right-frame">
        ...
        <div class="content">
            ...
            <h1>member access</h1>
            <p>Here's a suggested episode for you to watch, drawn from the series and seasons you have in your collection.  Click <em>Suggest</em> above to refresh the selection, and <em>Collection</em> to manage your series access.</p>
